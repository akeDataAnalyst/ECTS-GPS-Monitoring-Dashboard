NOC-ECTS-GPS-Monitoring-Dashboard
...
## Description
This project simulates a complete real-time GPS monitoring system for National Oil Ethiopia (NOC), modeled after their Electronic Cargo Tracking System (ECTS).
